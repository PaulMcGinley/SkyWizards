...
#include "TessellatedFloor.h"

#include <SFML/Graphics/Shader.hpp>

TessellatedFloor::TessellatedFloor() {
    //load maintex from file
    mainTex.texture.loadFromFile("resources/floor.png");
    mainTex.CalculateQuads();
    mainSprite.setTexture(mainTex.texture);
    //mainSprite.setPosition(position);
    mainSprite.setColor(sf::Color(0,150,0));
    highlightTex.texture.loadFromFile("resources/floor.png");
